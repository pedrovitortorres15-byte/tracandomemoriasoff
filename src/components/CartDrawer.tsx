            ...
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 rounded-lg bg-muted/50">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-semibold text-sm text-primary">{item.price.currencyCode} {parseFloat(item.price.amount).toFixed(2)}</p>
                      </div>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-primary">{items[0]?.price.currencyCode || 'BRL'} {totalPrice.toFixed(2)}</span>
                </div>
